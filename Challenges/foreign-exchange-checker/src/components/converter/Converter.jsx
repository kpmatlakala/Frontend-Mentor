...
export default function Converter() {
  ...
  const isFavorite = useFxStore(state => state.favorites.includes(`${fromCurrency}/${toCurrency}`));
  ...
  return (
    <div className="bg-neutral-700 rounded-[20px] shadow-[0px_12px_40px_0px_rgba(0,0,0,0.40)] overflow-hidden">
      ...
      <div className="px-5 py-4 border-t border-neutral-500 flex flex-wrap justify-between items-center gap-3">
